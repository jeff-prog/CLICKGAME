...
function updateEnergyDisplay() {
    ...
    document.getElementById("energy-amount").textContent = Math.max(0, Math.round(energy)) + "%"; // Atualiza a porcentagem da energia
}
...
window.onload = function() {
    ...
    updateEnergyDisplay(); // Chama a função para definir a exibição inicial da energia
};
